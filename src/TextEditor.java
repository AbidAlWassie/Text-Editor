...
public class TextEditor extends JFrame implements ActionListener, DocumentListener {
    ...
    private void buildFileMenu() {
        ...
        file.setMnemonic('F');
        menu.add(file);
        JMenuItem n = new JMenuItem("New", new ImageIcon(getClass().getResource("Images/new.png")));
        n.setMnemonic('N');
        ...
        JMenuItem saveas = new JMenuItem("Save as...", new ImageIcon(getClass().getResource("Images/save.png")));
